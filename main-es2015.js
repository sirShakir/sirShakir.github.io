...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 33, vars: 0, consts: [["width", "26px", "height", "26px", "viewBox", "0 0 1339 1024", "xmlns", "http://www.w3.org/2000/svg", 1, "", 3, "click"], ["d", "M0 0h1102.769v78.769h-1102.769v-78.769z", 2, "fill", "#E4BB97"], ["d", "M0 315.077h1339.077v78.769h-1339.077v-78.769z", 2, "fill", "#840032"], ["d", "M0 630.154h945.231v78.769h-945.231v-78.769z", 2, "fill", "#E4BB97"], ["d", "M0 945.231h1220.923v78.769h-1220.923v-78.769z", 2, "fill", "#840032"], ["id", "menuTransition", "src", "https://media.giphy.com/media/VxbP9tLeKzazm/giphy.gif", "alt", "Girl in a jacket"], ["id", "menubar"], ["id", "heading", 1, "headingF", 3, "click"], [1, "fab", "fa-github", "i1", 2, "font-size", "18px", 3, "click"], [1, "fab", "fa-linkedin-in", "i1", 2, "font-size", "18px", 3, "click"], [1, "fab", "fa-youtube", "i1", 2, "font-size", "18px", 3, "click"], [1, "fab", "fa-stack-exchange", "i1", 2, "font-size", "18px", 3, "click"], [1, "fas", "fa-book", "i1", 2, "font-size", "18px", 3, "click"], [1, "fas", "fa-chalkboard-teacher", "i1", 2, "font-size", "18px", 3, "click"], ["id", "story", 1, "defaultP", 3, "click"], ["id", "projects", 1, "defaultP", 3, "click"], ["action", "/action_page.php"], [1, "formP", 3, "click"], [1, "fas", "fa-book", "i2", 2, "font-size", "18px", 3, "click"], [1, "fab", "fa-linkedin-in", "i2", 2, "font-size", "18px", 3, "click"], [1, "fas", "fa-chalkboard-teacher", "i2", 2, "font-size", "18px", 3, "click"], ["id", "app"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_h2_click_7_listener() { return ctx.goZyris(); });
...
/* harmony import */ var three_examples_jsm_controls_TransformControls__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! three/examples/jsm/controls/TransformControls */ "./node_modules/three/examples/jsm/controls/TransformControls.js");
...
class ZyrisComponent {
    ...
    ngOnInit() {
        ...
        this.gui = new dat_gui__WEBPACK_IMPORTED_MODULE_4__["GUI"]();
        // Canvas
        ...
        //   return color;
        // }
        const geometry = new three__WEBPACK_IMPORTED_MODULE_2__["TorusGeometry"](.7, .2, 16, 100);
        ...
        this.scene.background = new three__WEBPACK_IMPORTED_MODULE_2__["Color"]("black");
        //const pointLight = new THREE.HemisphereLight( 0xffffbb, 0x080820, 1 );
        const pointLight = new three__WEBPACK_IMPORTED_MODULE_2__["DirectionalLight"](0xffffff, 1);
        ...
        const pointLightHelper = new three__WEBPACK_IMPORTED_MODULE_2__["PointLightHelper"](pointLight, 1);
        ...
        this.orbitControler = new three_examples_jsm_controls_OrbitControls_js__WEBPACK_IMPORTED_MODULE_3__["OrbitControls"](this.camera, this.renderer.domElement);
        //this.orbitControler.update();
        /* */
        this.loadModels();
        this.hotkeySetups();
    ...
    loadModels() {
        let classobj = this;
        let fontLoader = new three__WEBPACK_IMPORTED_MODULE_2__["FontLoader"]();
        fontLoader.load('assets/zcool.json', (font) => {
            ...
            let textGeoGame = new three__WEBPACK_IMPORTED_MODULE_2__["TextGeometry"]('Zyris', geometrySetting);
            let textGeoStop = new three__WEBPACK_IMPORTED_MODULE_2__["TextGeometry"]('Shakir', geometrySetting);
            let textMatGame = new three__WEBPACK_IMPORTED_MODULE_2__["MeshLambertMaterial"]({ color: 0xE4BB97 });
            let textMatStop = new three__WEBPACK_IMPORTED_MODULE_2__["MeshLambertMaterial"]({ color: 0x840032 });
            let textGame = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](textGeoGame, textMatGame);
            let textStop = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](textGeoStop, textMatStop);
            this.text1 = textGame;
            this.text2 = textStop;
    ...
    cameraSetup() {
        this.camera = new three__WEBPACK_IMPORTED_MODULE_2__["PerspectiveCamera"](75, window.innerWidth / window.innerHeight, 0.1, 50000);
    ...
    addStars() {
        ...
        for (let i = 0; i < 6000; i++) {
            let star = new three__WEBPACK_IMPORTED_MODULE_2__["Vector3"](Math.random() * 600 - 300, Math.random() * 600 - 300, Math.random() * 600 - 300);
            star.velocity = 0;
        ...
        let sprite = new three__WEBPACK_IMPORTED_MODULE_2__["TextureLoader"]().load('assets/star.png');
        let starMaterial = new three__WEBPACK_IMPORTED_MODULE_2__["PointsMaterial"]({
            color: '#5DADE2',
            size: 0.7,
            map: sprite
        });
