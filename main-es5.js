...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_h1_click_7_listener() {
            return ctx.goZyris();
          });
  ...
  function srcAppZyrisZyrisComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! three */
    "./node_modules/three/build/three.module.js"); //const gui = new dat.GUI()
    ...
    var ZyrisComponent = /*#__PURE__*/function () {
      ...
      _createClass(ZyrisComponent, [{
        ...
        value: function ngOnInit() {
          ...
          scene.add(sphere); //const pointLight = new THREE.HemisphereLight( 0xffffbb, 0x080820, 1 );
          ...
          scene.add(pointLight); // gui.add(pointLight.position, 'y').min(-300).max(300).step(0.01)
          ...
          scene.add(camera);
          this.camera = camera; // const pointLightHelper = new THREE.PointLightHelper(pointLight, 1)
          ...
          renderer.setSize(sizes.width, sizes.height);
          renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2)); //const controls = new OrbitControls(camera, renderer.domElement)
          ...
          var tick = function tick() {
            ...
            sphere.rotation.y = .5 * elapsedTime; // if(pointLight.position.x < -300){
            // }
          ...
          fontLoader.load('assets/zcool.json', function (font) {
            ...
            var textGeoGame = new three__WEBPACK_IMPORTED_MODULE_1__["TextGeometry"]('Zyris', geometrySetting);
            var textGeoStop = new three__WEBPACK_IMPORTED_MODULE_1__["TextGeometry"]('Shakir', geometrySetting);
            var textMatGame = new three__WEBPACK_IMPORTED_MODULE_1__["MeshLambertMaterial"]({
              color: 0xE4BB97
            });
            var textMatStop = new three__WEBPACK_IMPORTED_MODULE_1__["MeshLambertMaterial"]({
              color: 0x840032
            });
            var textGame = new three__WEBPACK_IMPORTED_MODULE_1__["Mesh"](textGeoGame, textMatGame);
            var textStop = new three__WEBPACK_IMPORTED_MODULE_1__["Mesh"](textGeoStop, textMatStop);
